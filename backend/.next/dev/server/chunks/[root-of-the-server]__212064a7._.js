...
const authOptions = {
    ...
    callbacks: {
        ...
        async redirect ({ url, baseUrl }) {
            ...
            const frontendUrl = ("TURBOPACK compile-time value", "http://localhost:5173") || "http://localhost:5173";
...
"[project]/src/app/api/auth/customer-login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const callbackUrl = searchParams.get("callbackUrl") || "http://localhost:5173/customer/dashboard";
    ...
    if (session?.user?.role === "customer") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(callbackUrl);
    }
    // Redirect to NextAuth Google signin with callback
    const signinUrl = new URL("/api/auth/signin/google", origin);
    signinUrl.searchParams.set("callbackUrl", callbackUrl);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(signinUrl);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__212064a7._.js.map