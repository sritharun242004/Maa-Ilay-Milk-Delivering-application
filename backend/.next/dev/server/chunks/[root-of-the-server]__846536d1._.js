...
"[project]/src/app/api/admin/inventory/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        let inventory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventory.findFirst();
        if (!inventory) {
            inventory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventory.create({
                data: {
                    largeBottlesTotal: 0,
                    smallBottlesTotal: 0,
        ...
        const bottleStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bottleLedger.groupBy({
            by: [
                "customerId"
            ],
            _max: {
        ...
        // Get inventory logs
        const recentLogs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventoryLog.findMany({
            orderBy: {
                createdAt: "desc"
            },
            take: 20
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch inventory", 500);
    }
}
async function POST(request) {
    try {
        ...
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inventoryUpdateSchema"].safeParse(body);
        if (!result.success) {
        ...
        if (newLargeTotal < 0 || newSmallTotal < 0) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Cannot reduce inventory below zero", 400);
        }
        // Update inventory
        const updatedInventory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventory.update({
            where: {
                id: inventory.id
            },
            data: {
        ...
        // Create log
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventoryLog.create({
            data: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminAuditLog.create({
            data: {
                ...
                oldValue: {
                    large: inventory.largeBottlesTotal,
                    small: inventory.smallBottlesTotal
                },
                newValue: {
                    large: newLargeTotal,
                    small: newSmallTotal,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to update inventory", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__846536d1._.js.map