...
"[project]/src/app/api/delivery/today/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const bottleBalances = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bottleLedger.groupBy({
            by: [
                "customerId"
            ],
            where: {
        ...
        const balanceMap = new Map(bottleBalances.map((b)=>[
                b.customerId,
                {
        ...
        const enhancedDeliveries = deliveries.map((d)=>({
                ...d,
                customerBottleBalance: balanceMap.get(d.customerId) || {
                    largeBottles: 0,
                    smallBottles: 0
                }
            }));
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch deliveries", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__f4746f21._.js.map