...
async function GET() {
    try {
        ...
        tomorrow.setDate(tomorrow.getDate() + 1);
        // Get counts
        const [pendingApprovals, activeCustomers, totalCustomers, activeDeliveryPersons, todaysDeliveries, tomorrowsDeliveries, inventory] = await Promise.all([
            // Pending approvals
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].customer.count({
                where: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deliveryPerson.count({
                where: {
                    isActive: true
                }
            }),
            // Today's deliveries
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].delivery.findMany({
                where: {
                    deliveryDate: today
                },
                include: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].delivery.count({
                where: {
            ...
            // Inventory
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].inventory.findFirst()
        ]);
        ...
        const recentTransactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].walletTransaction.findMany({
            where: {
                createdAt: {
        ...
        const todayRevenue = todaysDeliveries.filter((d)=>d.status === "DELIVERED").reduce((sum, d)=>sum + d.chargePaise + d.depositPaise, 0);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to fetch dashboard data", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__499fc4ec._.js.map