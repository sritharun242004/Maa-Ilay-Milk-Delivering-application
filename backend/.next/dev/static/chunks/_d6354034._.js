...
"[project]/src/app/admin/holidays/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HolidaysPage() {
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "HolidaysPage.useQuery": async ()=>{
                const res = await fetch("/api/admin/holidays");
                if (!res.ok) throw new Error("Failed to fetch");
                return res.json();
            }
        }["HolidaysPage.useQuery"]
    });
    const createMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "HolidaysPage.useMutation[createMutation]": async ()=>{
                const res = await fetch("/api/admin/holidays", {
                    method: "POST",
                    headers: {
        ...
        }["HolidaysPage.useMutation[createMutation]"],
        onSuccess: {
            "HolidaysPage.useMutation[createMutation]": (data)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Holiday created. ${data.data.affectedCustomers} customers affected.`);
        ...
        onError: {
            "HolidaysPage.useMutation[createMutation]": (err)=>{
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "HolidaysPage.useMutation[deleteMutation]": async (holidayDate)=>{
        ...
        }["HolidaysPage.useMutation[deleteMutation]"],
        onSuccess: {
            "HolidaysPage.useMutation[deleteMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Holiday removed");
                queryClient.invalidateQueries({
                    queryKey: [
                        "holidays"
                    ]
        ...
        onError: {
            "HolidaysPage.useMutation[deleteMutation]": (err)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(err.message);
            }
        }["HolidaysPage.useMutation[deleteMutation]"]
    });
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(holiday.date),
                                                        " · ",
...
_s(HolidaysPage, "KCkWSRmfjear5/sNWARdEZZPn8I=", false, function() {
    return [
...
_c = HolidaysPage;
var _c;
__turbopack_context__.k.register(_c, "HolidaysPage");
...
//# sourceMappingURL=_d6354034._.js.map