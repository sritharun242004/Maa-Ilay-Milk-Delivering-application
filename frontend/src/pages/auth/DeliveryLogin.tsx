          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2.5 pr-10 border border-gray-200 rounded-lg text-sm focus:border-green-800 focus:ring-2 focus:ring-green-800/10 transition-colors outline-none"
              />
              <button
                type="button"
